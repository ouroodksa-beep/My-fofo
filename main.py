...
def get_high_quality_image(soup):
    ...
    try:
        ...
        if img:
            ...
            # محاولة 2: data-a-dynamic-image (JSON بأحجام متعددة)
            dyn = img.get("data-a-dynamic-image")
            if dyn:
                try:
                    data = json.loads(dyn)
                    # اختيار أكبر حجم متاح
...
def handler(msg):
    ...
    for url in urls:
        ...
        # استخدام الرابط الأصلي زي ما هو
        original_url = url
